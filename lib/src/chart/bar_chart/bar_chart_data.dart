...
class BarChartData extends AxisChartData with EquatableMixin {
  ...
  final FlErrorIndicatorData<BarChartSpotErrorRangeCallbackInput> errorIndicatorData;
  ...
  BarChartData copyWith({
    ...
    FlErrorIndicatorData<BarChartSpotErrorRangeCallbackInput>? errorIndicatorData,
  }) => BarChartData(
...
class BarChartRodStackItem with EquatableMixin {
  ...
  /// When non-null, positions the label at the tip of the segment
  /// offset by this value, instead of centering it.
  /// Positive [Offset.dy] moves the label inward from the segment's tip.
  final Offset? labelOffset;

  /// When true and [labelOffset] is set, positions the label at the
  /// [fromY] end of the segment instead of the [toY] end.
  final bool labelAtStart;
  ...
  BarChartRodStackItem copyWith({
    ...
    labelAtStart: labelAtStart ?? this.labelAtStart,
    borderSide: borderSide ?? this.borderSide,
  );
...
/// of tooltip popup.
typedef GetBarTooltipColor =
    Color Function(
      BarChartGroupData group,
    );

/// Default implementation for [BarTouchTooltipData.getTooltipColor].
Color defaultBarTooltipColor(BarChartGroupData group) => Colors.blueGrey.darken(15);
...
class BarChartSpotErrorRangeCallbackInput extends FlSpotErrorRangeCallbackInput {
...
class BarChartRodLabel extends FlLabel {
  ...
  /// When true, the label is drawn inside the bar [offset.dy] pixels
  /// from the tip instead of outside.
  final bool positionInside;
  ...
  static BarChartRodLabel lerpBarChartRodLabel(
    ...
    return BarChartRodLabel(
      ...
      positionInside: b.positionInside,
    );
  }
  ...
  BarChartRodLabel copyWith({
    ...
    positionInside: positionInside ?? this.positionInside,
  );

  @override
  List<Object?> get props => [show, text, style, angle, textDirection, offset, positionInside];
}
