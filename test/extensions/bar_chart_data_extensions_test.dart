...
void main() {
  group('BarChartDataExtension.calculateGroupsX', () {
    test('calculates correct positions for basic alignments', () {
      expect(
        MockData.barChartData1.copyWith(alignment: BarChartAlignment.start).calculateGroupsX(100),
        [9.0, 43.0, 77.0],
      );

      expect(
        MockData.barChartData1.copyWith(alignment: BarChartAlignment.end).calculateGroupsX(100),
        [23.0, 57.0, 91.0],
      );

      expect(
        MockData.barChartData1.copyWith(alignment: BarChartAlignment.center).calculateGroupsX(100),
        [16.0, 50.0, 84.0],
      );
    ...
    for (final alignment in [
      ...
      test(
        ...
        () {
          expect(
            MockData.barChartData1.copyWith(alignment: alignment).calculateGroupsX(60),
            [10.5, 30.0, 49.5],
          );
        },
      );
    ...
    test('Throws Assertion error when barGroups is empty', () {
      expect(
        () => MockData.barChartData1.copyWith(barGroups: []).calculateGroupsX(100),
